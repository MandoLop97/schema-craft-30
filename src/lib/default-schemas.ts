...
export function createHomeSchema(): Schema {
  return {
    ...
    nodes: {
      ...
      'products-grid': { id: 'products-grid', type: 'ProductGrid', props: { columns: 4, limit: 4 }, style: { gap: '1.5rem' }, children: [] },
...
export function createProductsSchema(): Schema {
  return {
    ...
    nodes: {
      ...
      'products-grid': { id: 'products-grid', type: 'ProductGrid', props: { columns: 3, limit: 12 }, style: { gap: '1.5rem' }, children: [] },
      ...sharedFooter(),
    },
  };
}
