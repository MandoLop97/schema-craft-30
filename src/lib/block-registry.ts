...
export const blockRegistry: BlockDefinition[] = [
  ...
  { 
    ...
    icon: LayoutGrid, 
    canHaveChildren: false, 
    defaultProps: { columns: 4, limit: 8, category: '', gap: '1.5rem', sort: '' }, 
    ...
    inspectorFields: [
      ...
      { key: 'sort', label: 'Sort Order', type: 'select', options: [{ label: 'Default', value: '' }, { label: 'Price: Low to High', value: 'price-asc' }, { label: 'Price: High to Low', value: 'price-desc' }, { label: 'Newest First', value: 'newest' }, { label: 'Most Popular', value: 'popular' }] },
  ...
  { 
    ...
    icon: Layers, 
    canHaveChildren: false, 
    defaultProps: { heading: 'Build Something Amazing', subtitle: 'The all-in-one platform to launch your next big idea — fast, beautiful, and effortless.', overlayText: '', ctaText: 'Get Started', ctaLink: '#', secondaryCtaText: '', secondaryCtaLink: '', src: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1920&h=800&fit=crop', overlayOpacity: '0.55' }, 
    defaultStyle: { minHeight: '32rem', padding: '4rem 2rem' },
    supportsBinding: true,
    inspectorFields: [
      { key: 'overlayText', label: 'Badge / Overlay Text', type: 'text', placeholder: 'e.g. New Collection 2026' },
      { key: 'heading', label: 'Heading', type: 'text' },
      { key: 'subtitle', label: 'Subtitle', type: 'textarea', rows: 2 },
      { key: 'src', label: 'Background Image (URL)', type: 'image' },
      { key: 'overlayOpacity', label: 'Overlay Opacity (%)', type: 'slider', min: 0, max: 100, step: 5, defaultValue: 55 },
      { key: 'ctaText', label: 'Primary CTA Text', type: 'text' },
      { key: 'ctaLink', label: 'Primary CTA Link', type: 'link', placeholder: '/products' },
      { key: 'secondaryCtaText', label: 'Secondary CTA Text', type: 'text' },
      { key: 'secondaryCtaLink', label: 'Secondary CTA Link', type: 'link', placeholder: '/products?sort=newest' },
      { key: 'textAlign', label: 'Text Alignment', type: 'select', options: [{ label: 'Center', value: 'center' }, { label: 'Left', value: 'left' }, { label: 'Right', value: 'right' }] },
    ],
    description: 'Full-width hero with background image, badge, overlay and dual CTAs',
  },
  { 
    type: 'ImageBanner', 
    label: 'Image Banner', 
