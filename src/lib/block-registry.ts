...
export const blockRegistry: BlockDefinition[] = [
  ...
  { type: 'ProductGrid', label: 'Product Grid', category: 'Commerce', icon: LayoutGrid, canHaveChildren: false, defaultProps: { columns: 4, limit: 8, category: '', gap: '1.5rem' }, defaultStyle: { padding: '2rem' }, inspectorFields: [
