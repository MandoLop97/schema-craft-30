...
export const DEFAULT_SAMPLE_COLLECTIONS = [
 ...
 */
export function buildHostData(hostData?: Record<string, any>) {
  return {
    products: hostData?.products || DEFAULT_SAMPLE_PRODUCTS,
    collections: hostData?.collections || DEFAULT_SAMPLE_COLLECTIONS,
    settings: hostData?.settings || DEFAULT_SAMPLE_SETTINGS,
    pages: hostData?.pages || [],
    custom: hostData?.custom || {},
  };
}
...
export const DEFAULT_MOCK_PRODUCTS = DEFAULT_SAMPLE_PRODUCTS;
/** @deprecated Use DEFAULT_SAMPLE_COLLECTIONS */
export const DEFAULT_MOCK_COLLECTIONS = DEFAULT_SAMPLE_COLLECTIONS;
/** @deprecated Use DEFAULT_SAMPLE_SETTINGS */
export const DEFAULT_MOCK_SETTINGS = DEFAULT_SAMPLE_SETTINGS;
/** @deprecated Use buildHostData */
export const buildMockRenderData = buildHostData;
